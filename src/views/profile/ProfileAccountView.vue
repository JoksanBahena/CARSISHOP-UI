        ...
        <v-row>
          <v-col cols="12" md="4">
            <v-img lazy-src="@/assets/imgs/men_card.webp" src="@/assets/imgs/men_card.webp" width="200" height="200"
              aspect-ratio="1" class="-lighten-2 rounded-circle" cover>
            </v-img>
          </v-col>
          <v-col cols="12" md="4" class="mt-auto">
            <div class="mb-4">
              ...
              <v-text-field density="compact" placeholder="Nombre(s)" prepend-inner-icon="mdi-account-outline"
                variant="outlined" :disabled="is_disabled" />
          ...
          <v-col cols="12" md="4">
            <div class="mb-4">
              ...
              <v-text-field density="compact" placeholder="Correo electrónico"
                prepend-inner-icon="mdi-calendar-month-outline" variant="outlined" :disabled="is_disabled" />
            </div>
          </v-col>
          <v-col cols="12" md="4">
            <div class="mb-4">
        ...
        <v-row>
          ...
          <v-col cols="12" md="4">
            ...
            <v-file-input density="compact" type="file" accept="image/png, image/jpeg, image/bmp" variant="outlined"
              prepend-icon="mdi-camera-outline" chips show-size @change="onFileChange" :disabled="is_disabled" />
          </v-col>
        </v-row>
        <v-row>
          <v-divider></v-divider>
          ...
          <v-col cols="12">
            <v-btn variant="outlined" prepend-icon="mdi-pencil" class="text-none" :color="colors.primary_dark"
              size="large" block @click="is_disabled ? onEdit() : onSave()">
